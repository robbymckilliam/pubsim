...
/**
 * Creates a vector of coloured Guassian noise.
 * @author Robby McKilliam
 */
public class ColouredGaussianNoiseVector extends IIDNoiseVector implements SignalGenerator {
    
    protected final double[] corsignal;
    protected final double[] mean;
    protected final Matrix chol;

    /** Initialise this generator with a mean vector and correlation matrix */
    public ColouredGaussianNoiseVector(double[] mean, Matrix cor){
        super(mean.length);
    ...
    public ColouredGaussianNoiseVector(Matrix cor){
