...
public class Transmitter extends Object {
     ...
     */
    public Transmitter(RealRandomVariable pgen, RealRandomVariable wgen){
     ...
     * @param wgen generator for transmitter wavelengths.
     */
    public static Transmitter[] getRandomArray(int N, RealRandomVariable pgen, RealRandomVariable wgen){
