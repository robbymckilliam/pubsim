...
import Jama.Matrix;
import robbysim.lattices.reduction.LLL;
import robbysim.lattices.util.PointInSphere;
import robbysim.VectorFunctions;
import static robbysim.Util.binom;
import static robbysim.Util.factorial;
import static robbysim.Util.discreteLegendrePolynomial;
...
public class VnmStarGlued extends VnmStar {
     ...
     */
    private class SphereDecoder extends robbysim.lattices.decoder.SphereDecoder{
