...
import robbysim.psk.decoder.Util;
import robbysim.psk.decoder.CoxeterNoncoherentReciever;
import robbysim.psk.decoder.CoxeterCodedPSKSignal;
...
public class CoxeterNoncoherentRecieverTest {
    ...
    public void decode() {
        ...
        RandomVariable noise = new robbysim.distributions.GaussianNoise(0.0, 0.05);
