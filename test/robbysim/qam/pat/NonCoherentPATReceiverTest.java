...
import robbysim.qam.pat.NonCoherentPATReceiver;
import robbysim.qam.pat.PilotAssistedFadingNoisyQAM;
...
public class NonCoherentPATReceiverTest extends TestCase {
    ...
    public void testDecode() {
        ...
        System.out.println(" tr = " + robbysim.VectorFunctions.print(siggen.getTransmittedRealQAMSignal()));
        System.out.println(" ti = " + robbysim.VectorFunctions.print(siggen.getTransmittedImagQAMSignal()));
        System.out.println(" dr = " + robbysim.VectorFunctions.print(instance.getReal()));
        System.out.println(" di = " + robbysim.VectorFunctions.print(instance.getImag()));
        
        assertEquals(true, robbysim.VectorFunctions.distance_between(
