...
import robbysim.lattices.nearset.NearestInZnToAffineSurface;
import robbysim.lattices.nearset.NSphereForLines;
import robbysim.lattices.nearset.RegionForLines;
import robbysim.lattices.nearset.ParallelepipedForLines;
import Jama.Matrix;
...
public class NearestInZnToAffineSurfaceTest {
    ...
    public void sameAsPolyEst3() {
        ...
        for(int i = 0; i < a; i ++){
            scaler.set(i,i, -1.0/robbysim.Util.factorial(i));
        }
